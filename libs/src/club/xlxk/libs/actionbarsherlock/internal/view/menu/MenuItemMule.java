...
public class MenuItemMule implements MenuItem {
    ...
    private final club.xlxk.libs.actionbarsherlock.view.MenuItem mItem;

    public MenuItemMule(club.xlxk.libs.actionbarsherlock.view.MenuItem item) {
        mItem = item;
    }

    public club.xlxk.libs.actionbarsherlock.view.MenuItem unwrap() {
        return mItem;
    }
