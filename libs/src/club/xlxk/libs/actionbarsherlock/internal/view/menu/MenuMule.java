...
public class MenuMule implements Menu {
    ...
    private final club.xlxk.libs.actionbarsherlock.view.Menu mMenu;
    public boolean mDispatchShow = false;

    public MenuMule(club.xlxk.libs.actionbarsherlock.view.Menu menu) {
        mMenu = menu;
    }

    public club.xlxk.libs.actionbarsherlock.view.Menu unwrap() {
        return mMenu;
    }
